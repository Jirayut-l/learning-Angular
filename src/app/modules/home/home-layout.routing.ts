    ...
    children: [
      {
        ...
        children: [
          ...
          },
          {
            ...
            loadChildren: () =>
              import('./components/navigate-with-routing/navigate-with-routing.module').then(
                p => p.NavigateWithRoutingModule
              ),
          },
          {
          ...
          },
          {
            ...
            loadChildren: () => import('./components/animations/animations.module').then(p => p.AnimationsModule),
          },
        ],
      },
    ],
